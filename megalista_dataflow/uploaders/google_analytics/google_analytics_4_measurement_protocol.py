...
class GoogleAnalytics4MeasurementProtocolUploaderDoFn(MegalistaUploader):
    ...
    @utils.safe_process(
        logger=logging.getLogger(
            "megalista.GoogleAnalytics4MeasurementProtocolUploader"
        )
    )
    ...
    def do_process(self, batch: Batch):
        ...
        non_personalized_ads = self._str2bool(
            execution.destination.destination_metadata[3]
        )
        ...
        if not api_secret:
            raise ValueError("GA4 MP should be called with a non-null api_secret")
        ...
        payload: Dict[str, Any] = {"nonPersonalizedAds": non_personalized_ads}
        ...
        for row in batch.elements:
            ...
            if is_event:
                ...
                params = {
                    ...
                    if self._validate_param(k, v, event_reserved_keys)
                }
            ...
            if is_user_property:
                ...
                payload["events"] = {
                    "name": "user_property_addition_event",
                    "params": {},
                }
