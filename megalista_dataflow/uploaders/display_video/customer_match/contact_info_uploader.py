...
from uploaders.display_video.customer_match.abstract_uploader import (
    DisplayVideoCustomerMatchAbstractUploaderDoFn,
)
from uploaders import utils
from models.execution import DestinationType, AccountConfig


class DisplayVideoCustomerMatchContactInfoUploaderDoFn(
    DisplayVideoCustomerMatchAbstractUploaderDoFn
):
    def get_list_definition(
        ...
        return {
            ...
            "contactInfoList": {"contactInfos": list_to_add},
        }
    ...
    def get_update_list_definition(
        ...
        return {
            ...
            "addedContactInfoList": {"contactInfos": list_to_add},
        }
