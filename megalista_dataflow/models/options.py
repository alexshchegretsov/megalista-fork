...
class DataflowOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls, parser):
        ...
        parser.add_value_provider_argument(
            ...
            help="Name of Google Cloud Firestore collection with execution info (don't set if using Sheet or JSON)",
        )
        parser.add_value_provider_argument(
            "--bq_ops_dataset",
        ...
        parser.add_value_provider_argument(
            "--notify_errors_by_email",
            help="Should send errors by email. True or False",
        )
        parser.add_value_provider_argument(
            "--errors_destination_emails",
            help="Emails for sending errors separated by comma",
        )
        # DEBUG
        parser.add_value_provider_argument(
